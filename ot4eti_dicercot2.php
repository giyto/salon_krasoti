...
foreach ($results as $result) {
    $labels[] = htmlspecialchars($result['service']);
...
<body>
    <div class="container">
        ...
        <div class="results-section">
            <h1>Отчет об объемах оказанных услуг за период с <?= htmlspecialchars($dateFromFormatted) ?> по <?= htmlspecialchars($dateToFormatted) ?></h1>
            <table>
                <thead>
                    <tr>
                        <th>Услуга</th>
                ...
                <tbody>
                    <?php if (!empty($results)): ?>
                        <?php foreach ($results as $result): ?>
                            <tr>
                                <td><?= htmlspecialchars($result['service']) ?></td>
